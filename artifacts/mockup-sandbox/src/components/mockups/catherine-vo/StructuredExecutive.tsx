...
export function StructuredExecutive() {
  return (
    <div className="min-h-screen w-full bg-[#F7F5F0] text-[#1C1E21] font-sans selection:bg-[#A85A32] selection:text-white flex flex-col">
      ...
      {/* HEADER */}
      <header className="w-full border-b border-[#C8BAAE] bg-[#F7F5F0] sticky top-0 z-50">
      ...
      <section className="w-full pt-16 pb-20 md:pt-24 md:pb-28">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center">
          <div className="lg:col-span-7 flex flex-col items-start">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 border border-[#B87333] text-[#B87333] text-xs font-bold tracking-widest uppercase mb-8">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md aspect-[3/4] bg-[#EAE6DF] border-[12px] border-[#EAE6DF] shadow-2xl">
              ...
              <div className="absolute -bottom-6 -left-6 z-20 bg-[#F7F5F0] border-l-4 border-[#C8BAAE] p-5 shadow-xl min-w-[200px]">
      ...
      {/* METRICS SECTION */}
      <section className="w-full bg-[#EAE6DF] py-16 border-y border-[#C8BAAE]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-6 lg:divide-x divide-[#C8BAAE]">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
            ...
            <div className="flex flex-col group">
              ...
              <div className="bg-[#1C1E21]/40 p-6 border-l-4 border-[#C8BAAE]">
                <div className="font-body text-[10px] font-bold text-[#B87333] uppercase tracking-widest mb-3">Proof Point</div>
            ...
            <div className="flex flex-col group">
              ...
              <div className="bg-[#1C1E21]/40 p-6 border-l-4 border-[#C8BAAE]">
                <div className="font-body text-[10px] font-bold text-[#B87333] uppercase tracking-widest mb-3">Credential</div>
                <p className="font-display text-sm text-[#EAE6DF] font-medium leading-relaxed">
      ...
      <section className="w-full bg-[#F7F5F0] py-24">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col">
            <div className="bg-white p-10 border border-[#C8BAAE] shadow-sm relative">
              ...
              <div className="flex flex-wrap gap-2">
                {["Visionary-Integrator Partnership", "Scorecard Tracking", "Change Management", "M&A Onboarding", "Cross-Functional Alignment", "Pipeline Governance"].map(scope => (
                  <span key={scope} className="bg-[#EAE6DF] text-[#1C1E21] border border-[#C8BAAE] px-3 py-2 text-sm font-body font-bold tracking-wide">
                    {scope}
                  </span>
                ))}
              </div>
      ...
      {/* FOOTER */}
      <footer className="w-full bg-[#F7F5F0] border-t border-[#C8BAAE] py-12">
