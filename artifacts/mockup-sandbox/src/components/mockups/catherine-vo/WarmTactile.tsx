  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{ background: "radial-gradient(circle, #C47A4A 0%, rgba(196,122,74,0) 70%)" }}
      ></div>
      <div 
        className="absolute top-[40%] right-[-10%] w-[40%] h-[60%] rounded-full blur-[140px] opacity-[0.15] pointer-events-none"
        style={{ background: "radial-gradient(circle, #A85A32 0%, rgba(168,90,50,0) 70%)" }}
      ></div>

      {/* Navigation / Header */}
      <header className="w-full border-b" style={{ borderColor: "rgba(168,90,50,0.15)" }}>
        <div className="max-w-7xl mx-auto px-6 py-6 flex justify-between items-center">
          <div className="font-serif text-2xl tracking-tight" style={{ color: "#1C1E21" }}>
            Catherine Vo<span style={{ color: "#A85A32" }}>.</span>
          </div>
          <div className="hidden md:flex items-center gap-6 text-sm font-medium" style={{ color: "#6B6560" }}>
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="w-full lg:w-3/5 z-10 flex flex-col items-start">
            <div 
              ...
              style={{ backgroundColor: "#EAE6DF", color: "#A85A32" }}
            >
              <span className="w-2 h-2 rounded-full" style={{ backgroundColor: "#A85A32" }}></span>
            ...
            <h1 
              ...
              style={{ color: "#1C1E21" }}
            >
              The operational engine behind <span className="italic" style={{ color: "#A85A32" }}>visionary founders.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <button 
                className="w-full sm:w-auto px-8 py-4 rounded-xl font-medium transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg"
                style={{ backgroundColor: "#A85A32", color: "#FFFFFF", boxShadow: "0 10px 25px -5px rgba(168,90,50,0.3)" }}
              >
              ...
              <button 
                ...
                style={{ border: "1px solid #1C1E21", color: "#1C1E21" }}
              >
                View My Experience
              </button>
            </div>
      ...
      <section 
        ...
        style={{ borderColor: "rgba(168,90,50,0.1)", backgroundColor: "#EAE6DF" }}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4 divide-x-0 md:divide-x" style={{ divideColor: "rgba(107,101,96,0.2)" }}>
            <div className="flex flex-col items-center text-center px-4">
              <span className="font-serif text-4xl md:text-5xl mb-2" style={{ color: "#A85A32" }}>$5M</span>
              <span className="text-sm font-medium uppercase tracking-wider" style={{ color: "#6B6560" }}>Annual Savings</span>
            </div>
            <div className="flex flex-col items-center text-center px-4">
              <span className="font-serif text-4xl md:text-5xl mb-2" style={{ color: "#3D4F58" }}>67%</span>
              <span className="text-sm font-medium uppercase tracking-wider" style={{ color: "#6B6560" }}>Backlog Reduction</span>
            </div>
            <div className="flex flex-col items-center text-center px-4">
              <span className="font-serif text-3xl md:text-4xl mb-2 flex items-center gap-2" style={{ color: "#A85A32" }}>
                14d <ArrowRight size={24} className="opacity-50" /> 2m
              </span>
              <span className="text-sm font-medium uppercase tracking-wider" style={{ color: "#6B6560" }}>Processing Time</span>
            </div>
            <div className="flex flex-col items-center text-center px-4">
              <span className="font-serif text-4xl md:text-5xl mb-2" style={{ color: "#3D4F58" }}>10M+</span>
              <span className="text-sm font-medium uppercase tracking-wider" style={{ color: "#6B6560" }}>Automated Ops</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-24 md:py-32 px-6">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6 text-lg" style={{ color: "#6B6560" }}>
            <p>
      ...
      <section className="w-full py-24 px-6 relative">
        <div className="absolute inset-0 opacity-40" style={{ backgroundColor: "#EAE6DF" }}></div>
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="mb-16 md:mb-24 flex flex-col md:flex-row gap-6 items-end justify-between">
            <h2 className="font-serif text-4xl md:text-5xl" style={{ color: "#1C1E21" }}>
              The Execution Framework
            </h2>
            <p className="max-w-md text-lg" style={{ color: "#6B6560" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div 
              ...
              style={{ backgroundColor: "#F7F5F0", boxShadow: "0 4px 20px rgba(0,0,0,0.03)" }}
            >
              <div 
                className="absolute top-0 right-0 w-32 h-32 rounded-bl-full transition-transform duration-500 group-hover:scale-110"
                style={{ backgroundColor: "#EAE6DF", opacity: 0.5 }}
              ></div>
              <div 
                className="w-12 h-12 rounded-xl flex items-center justify-center mb-8 relative z-10"
                style={{ backgroundColor: "#3D4F58", color: "#FFFFFF" }}
              >
                <Settings size={24} strokeWidth={1.5} />
              </div>
              <h3 className="text-sm font-bold uppercase tracking-wider mb-3" style={{ color: "#A85A32" }}>
                The Technical Engine
              </h3>
              <h4 className="font-serif text-2xl mb-4" style={{ color: "#1C1E21" }}>
                System Architecture & Process Lift
              </h4>
              <p className="mb-8 flex-grow" style={{ color: "#6B6560" }}>
              ...
              <div className="pt-6 border-t" style={{ borderColor: "rgba(107,101,96,0.15)" }}>
                <div className="text-xs font-bold uppercase tracking-wider mb-2" style={{ color: "#3D4F58" }}>Proof of Impact</div>
                <p className="text-sm italic" style={{ color: "#1C1E21" }}>
            ...
            >
              ...
              <div 
                className="w-12 h-12 rounded-xl flex items-center justify-center mb-8 relative z-10"
                style={{ backgroundColor: "#A85A32", color: "#FFFFFF" }}
              >
            ...
            >
              ...
              <div 
                className="w-12 h-12 rounded-xl flex items-center justify-center mb-8 relative z-10"
                style={{ backgroundColor: "#C47A4A", color: "#FFFFFF" }}
              >
              ...
              <div className="pt-6 border-t" style={{ borderColor: "rgba(107,101,96,0.15)" }}>
                <div className="text-xs font-bold uppercase tracking-wider mb-2" style={{ color: "#3D4F58" }}>Credential</div>
                <p className="text-sm italic" style={{ color: "#1C1E21" }}>
      ...
      <section className="w-full py-24 px-6 border-b" style={{ borderColor: "rgba(168,90,50,0.1)" }}>
        <div className="max-w-4xl mx-auto text-center mb-12">
          <h2 className="font-serif text-3xl md:text-4xl mb-6" style={{ color: "#1C1E21" }}>
        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-12">
          ...
          <div className="flex flex-col items-center">
            <div className="flex items-center gap-3 mb-6" style={{ color: "#3D4F58" }}>
          ...
          <div className="flex flex-col items-center">
            <div className="flex items-center gap-3 mb-6" style={{ color: "#A85A32" }}>
              <Workflow size={20} />
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {['Visionary-Integrator Partnership', 'Scorecard Tracking', 'Change Management', 'M&A Onboarding', 'Cross-Functional Alignment', 'Pipeline Governance'].map((scope) => (
                <span 
                  ...
                  style={{ backgroundColor: "#EAE6DF", color: "#1C1E21", borderColor: "rgba(28,30,33,0.05)" }}
                >
                  <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: "#A85A32" }}></span>
                  {scope}
                </span>
              ))}
            </div>
      ...
      <footer className="w-full relative px-6 py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center text-center">
          <div className="mb-6 w-16 h-16 rounded-full flex items-center justify-center" style={{ backgroundColor: "#F7F5F0", color: "#A85A32" }}>
            <Mail size={32} />
          </div>
          
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl mb-8" style={{ color: "#1C1E21" }}>
            Ready to establish your execution rhythm?
          </h2>
          
          <p className="text-xl mb-12 max-w-2xl" style={{ color: "#6B6560" }}>
            Let's discuss how we can clear your operational bottlenecks and build the systems your team needs to thrive.
          </p>
          
          <button 
            className="px-10 py-5 rounded-xl font-medium text-lg transition-all hover:scale-[1.02] active:scale-[0.98] shadow-xl mb-16 flex items-center gap-3"
            style={{ backgroundColor: "#A85A32", color: "#FFFFFF" }}
          >
          ...
          <div className="w-full h-px mb-12" style={{ backgroundColor: "rgba(107,101,96,0.15)" }}></div>
          
          <div className="flex flex-col md:flex-row justify-between w-full gap-8 items-center" style={{ color: "#6B6560" }}>
            <div className="flex flex-col items-center md:items-start gap-1">
              <span className="font-bold text-sm tracking-wider uppercase mb-1" style={{ color: "#1C1E21" }}>Location</span>
              <span>Austin, TX</span>
            </div>
            
            <div className="flex flex-col items-center gap-1">
              <span className="font-bold text-sm tracking-wider uppercase mb-1" style={{ color: "#1C1E21" }}>Direct</span>
              <a href="mailto:catherine@fourfoldcreative.com" className="hover:underline decoration-[#A85A32] underline-offset-4">
                catherine@fourfoldcreative.com
              </a>
              <a href="tel:5129097536" className="hover:underline decoration-[#A85A32] underline-offset-4">
                512-909-7536
              </a>
            </div>
            
            <div className="flex flex-col items-center md:items-end gap-1">
              <span className="font-bold text-sm tracking-wider uppercase mb-1" style={{ color: "#1C1E21" }}>Studio</span>
