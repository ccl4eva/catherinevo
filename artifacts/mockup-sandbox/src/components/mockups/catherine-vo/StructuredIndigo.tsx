...
export function StructuredIndigo() {
  return (
    <div className="min-h-screen w-full bg-[#F7F5F0] text-[#1C1E21] font-sans selection:bg-[#D4602A] selection:text-white flex flex-col">
      {/* Font Imports */}
      ...
      {/* HEADER */}
      <header className="w-full border-b border-[#1C1E21]/[0.12] bg-[#F7F5F0] sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-body text-[#6B6560] font-medium">
            <span className="flex items-center gap-2 hover:text-[#D4602A] transition-colors cursor-pointer">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center">
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <button className="w-full sm:w-auto px-8 py-4 bg-[#D4602A] hover:bg-[#B84E20] transition-colors text-white font-body font-bold text-sm tracking-wider uppercase flex items-center justify-center gap-2 group">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md aspect-[3/4] bg-[#EAE6DF] border-[12px] border-[#EAE6DF] shadow-2xl">
              ...
              <div className="absolute -bottom-6 -left-6 z-20 bg-[#F7F5F0] border-t-4 border-[#D4602A] p-5 shadow-xl min-w-[200px]">
                <div className="font-display font-extrabold text-[#1C1E21] text-lg uppercase tracking-wider mb-1">Catherine Vo</div>
                <div className="font-body text-[#2D3561] font-bold text-xs uppercase tracking-widest">Fourfold Creative</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-6 lg:divide-x divide-[#1C1E21]/20">
            ...
            <div className="flex flex-col lg:pl-10">
              <div className="font-display text-5xl font-extrabold text-[#1C1E21] mb-2 whitespace-nowrap">
                14<span className="text-3xl text-[#6B6560]">d</span> <span className="text-[#D4602A] text-4xl">→</span> 2<span className="text-3xl text-[#6B6560]">m</span>
              </div>
      ...
      {/* PILLARS SECTION */}
      <section className="w-full bg-[#2D3561] py-24 text-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
            ...
            <div className="flex flex-col group">
              <div className="w-14 h-14 bg-[#EAE6DF] text-[#2D3561] flex items-center justify-center mb-8 shadow-lg group-hover:bg-[#D4602A] group-hover:text-white transition-colors">
                <Settings size={28} />
              </div>
              ...
              <div className="bg-[#1C1E21]/40 p-6 border-l-4 border-[#D4602A]">
                <div className="font-body text-[10px] font-bold text-[#D4602A] uppercase tracking-widest mb-3">Proof Point</div>
            ...
            <div className="flex flex-col group">
              ...
              <div className="bg-[#1C1E21]/40 p-6 border-l-4 border-[#D4602A]">
                <div className="font-body text-[10px] font-bold text-[#D4602A] uppercase tracking-widest mb-3">Credential</div>
                <p className="font-display text-sm text-[#EAE6DF] font-medium leading-relaxed">
      ...
      <section className="w-full bg-[#F7F5F0] py-24">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            <div className="mb-10">
              <svg className="w-10 h-10 text-[#D4602A] mb-8" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
          ...
          <div className="lg:col-span-5 flex flex-col">
            <div className="bg-white p-10 border border-[#EAE6DF] shadow-sm relative">
              ...
              <h3 className="font-display text-lg font-extrabold text-[#1C1E21] uppercase tracking-widest mb-6 flex items-center gap-3">
                <Zap size={20} className="text-[#D4602A]" />
                Operational Scope
              </h3>
      ...
      {/* CTA SECTION */}
      <section className="w-full bg-[#1E2040] text-white py-24 text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <button className="px-10 py-5 bg-[#D4602A] hover:bg-[#B84E20] transition-colors text-white font-body font-bold text-sm tracking-wider uppercase inline-flex items-center justify-center gap-3 group">
            Book an Operational Audit
      ...
      <footer className="w-full bg-[#F7F5F0] border-t border-[#1C1E21]/10 py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-8 font-body text-sm font-bold text-[#6B6560]">
            <span className="hover:text-[#D4602A] transition-colors cursor-pointer flex items-center gap-2">
              <Mail size={16} /> catherine@fourfoldcreative.com
            </span>
            <span className="flex items-center gap-2">
