  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{ background: "radial-gradient(circle, #C9A84C 0%, rgba(201,168,76,0) 70%)" }}
      ></div>
      <div 
        className="absolute top-[40%] right-[-10%] w-[40%] h-[60%] rounded-full blur-[140px] opacity-[0.15] pointer-events-none"
        style={{ background: "radial-gradient(circle, #8B6914 0%, rgba(139,105,20,0) 70%)" }}
      ></div>

      {/* Navigation / Header */}
      <header className="w-full border-b" style={{ borderColor: "rgba(201,168,76,0.2)" }}>
        <div className="max-w-7xl mx-auto px-6 py-6 flex justify-between items-center">
          <div className="font-serif text-2xl tracking-tight" style={{ color: "#1A1710" }}>
            Catherine Vo<span style={{ color: "#8B6914" }}>.</span>
          </div>
          <div className="hidden md:flex items-center gap-6 text-sm font-medium" style={{ color: "#6B6148" }}>
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="w-full lg:w-3/5 z-10 flex flex-col items-start">
            <div 
              ...
              style={{ backgroundColor: "#F0EAD8", color: "#8B6914" }}
            >
              <span className="w-2 h-2 rounded-full" style={{ backgroundColor: "#C9A84C" }}></span>
            ...
            <h1 
              ...
              style={{ color: "#1A1710" }}
            >
              The operational engine behind <span className="italic" style={{ color: "#8B6914" }}>visionary founders.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <button 
                className="w-full sm:w-auto px-8 py-4 rounded-xl font-medium transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg bg-[#8B6914] hover:bg-[#7A5C10] text-white"
              ...
              <button 
                ...
                style={{ border: "1px solid #1A1710", color: "#1A1710" }}
              >
                View My Experience
              </button>
            </div>
          ...
          <div className="w-full lg:w-2/5 relative z-10">
            <div className="relative w-full aspect-[4/5] max-w-md mx-auto lg:ml-auto">
              ...
              <div 
                ...
                style={{ backgroundColor: "#8B6914", opacity: 0.2 }}
              ></div>
              <div 
      ...
      <section 
        ...
        style={{ borderColor: "rgba(139,105,20,0.1)", backgroundColor: "#F0EAD8" }}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4 divide-x-0 md:divide-x" style={{ divideColor: "rgba(107,97,72,0.2)" }}>
            <div className="flex flex-col items-center text-center px-4">
              <span className="font-serif text-4xl md:text-5xl mb-2" style={{ color: "#8B6914" }}>$5M</span>
              <span className="text-sm font-medium uppercase tracking-wider" style={{ color: "#6B6148" }}>Annual Savings</span>
            </div>
            <div className="flex flex-col items-center text-center px-4">
              <span className="font-serif text-4xl md:text-5xl mb-2" style={{ color: "#C9A84C" }}>67%</span>
              <span className="text-sm font-medium uppercase tracking-wider" style={{ color: "#6B6148" }}>Backlog Reduction</span>
            </div>
            <div className="flex flex-col items-center text-center px-4">
              <span className="font-serif text-3xl md:text-4xl mb-2 flex items-center gap-2" style={{ color: "#8B6914" }}>
                14d <ArrowRight size={24} className="opacity-50" /> 2m
              </span>
              <span className="text-sm font-medium uppercase tracking-wider" style={{ color: "#6B6148" }}>Processing Time</span>
            </div>
            <div className="flex flex-col items-center text-center px-4">
              <span className="font-serif text-4xl md:text-5xl mb-2" style={{ color: "#C9A84C" }}>10M+</span>
              <span className="text-sm font-medium uppercase tracking-wider" style={{ color: "#6B6148" }}>Automated Ops</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-24 md:py-32 px-6">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6 text-lg" style={{ color: "#6B6148" }}>
            <p>
      ...
      <section className="w-full py-24 px-6 relative">
        <div className="absolute inset-0 opacity-40" style={{ backgroundColor: "#F0EAD8" }}></div>
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="mb-16 md:mb-24 flex flex-col md:flex-row gap-6 items-end justify-between">
            <h2 className="font-serif text-4xl md:text-5xl" style={{ color: "#1A1710" }}>
              The Execution Framework
            </h2>
            <p className="max-w-md text-lg" style={{ color: "#6B6148" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-sm font-bold uppercase tracking-wider mb-3" style={{ color: "#8B6914" }}>
                The Technical Engine
              </h3>
              <h4 className="font-serif text-2xl mb-4" style={{ color: "#1A1710" }}>
                System Architecture & Process Lift
              </h4>
              <p className="mb-8 flex-grow" style={{ color: "#6B6148" }}>
              ...
              <div className="pt-6 border-t" style={{ borderColor: "rgba(107,97,72,0.15)" }}>
                <div className="text-xs font-bold uppercase tracking-wider mb-2" style={{ color: "#C9A84C" }}>Proof of Impact</div>
                <p className="text-sm italic" style={{ color: "#1A1710" }}>
            ...
            >
              ...
              <div className="pt-6 border-t" style={{ borderColor: "rgba(107,97,72,0.15)" }}>
                <div className="text-xs font-bold uppercase tracking-wider mb-2" style={{ color: "#C9A84C" }}>Credential</div>
                <p className="text-sm italic" style={{ color: "#1A1710" }}>
      ...
      <section className="w-full py-24 px-6 border-b" style={{ borderColor: "rgba(139,105,20,0.1)" }}>
        <div className="max-w-4xl mx-auto text-center mb-12">
          <h2 className="font-serif text-3xl md:text-4xl mb-6" style={{ color: "#1A1710" }}>
            Technical Depth & Operational Scope
          </h2>
          <p className="text-lg" style={{ color: "#6B6148" }}>
        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-12">
          ...
          <div className="flex flex-col items-center">
            <div className="flex items-center gap-3 mb-6" style={{ color: "#8B6914" }}>
              <Workflow size={20} />
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {['Visionary-Integrator Partnership', 'Scorecard Tracking', 'Change Management', 'M&A Onboarding', 'Cross-Functional Alignment', 'Pipeline Governance'].map((scope) => (
                <span 
                  ...
                  style={{ backgroundColor: "#F0EAD8", color: "#1A1710", borderColor: "rgba(26,23,16,0.05)" }}
                >
                  <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: "#8B6914" }}></span>
                  {scope}
                </span>
              ))}
            </div>
      ...
      <footer className="w-full relative px-6 py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center text-center">
          <div className="mb-6 w-16 h-16 rounded-full flex items-center justify-center" style={{ backgroundColor: "#FDFAF4", color: "#8B6914" }}>
            <Mail size={32} />
          </div>
          
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl mb-8" style={{ color: "#1A1710" }}>
            Ready to establish your execution rhythm?
          </h2>
          
          <p className="text-xl mb-12 max-w-2xl" style={{ color: "#6B6148" }}>
            Let's discuss how we can clear your operational bottlenecks and build the systems your team needs to thrive.
          </p>
          
          <button 
            className="px-10 py-5 rounded-xl font-medium text-lg transition-all hover:scale-[1.02] active:scale-[0.98] shadow-xl mb-16 flex items-center gap-3 bg-[#8B6914] hover:bg-[#7A5C10] text-white"
          >
            Start the Conversation
            <ArrowRight size={20} />
          </button>
          
          <div className="w-full h-px mb-12" style={{ backgroundColor: "rgba(107,97,72,0.15)" }}></div>
          
          <div className="flex flex-col md:flex-row justify-between w-full gap-8 items-center" style={{ color: "#6B6148" }}>
            <div className="flex flex-col items-center md:items-start gap-1">
              <span className="font-bold text-sm tracking-wider uppercase mb-1" style={{ color: "#1A1710" }}>Location</span>
              <span>Austin, TX</span>
            </div>
            
            <div className="flex flex-col items-center gap-1">
              <span className="font-bold text-sm tracking-wider uppercase mb-1" style={{ color: "#1A1710" }}>Direct</span>
              <a href="mailto:catherine@fourfoldcreative.com" className="hover:underline decoration-[#8B6914] underline-offset-4">
                catherine@fourfoldcreative.com
              </a>
              <a href="tel:5129097536" className="hover:underline decoration-[#8B6914] underline-offset-4">
                512-909-7536
              </a>
            </div>
            
            <div className="flex flex-col items-center md:items-end gap-1">
              <span className="font-bold text-sm tracking-wider uppercase mb-1" style={{ color: "#1A1710" }}>Studio</span>
